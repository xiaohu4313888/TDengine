...
sed -i '/dataDir/ {s/taos/kinghistorian/g}'  ${install_dir}/cfg/taos.cfg
sed -i '/logDir/  {s/taos/kinghistorian/g}'  ${install_dir}/cfg/taos.cfg
sed -i "s/TDengine/KingHistorian/g"     ${install_dir}/cfg/taos.cfg
sed -i "s/support@taosdata.com/support@wellintech.com/g"      ${install_dir}/cfg/taos.cfg
sed -i "s/taos client/khclient/g"      ${install_dir}/cfg/taos.cfg
sed -i "s/taosd/khserver/g"      ${install_dir}/cfg/taos.cfg
...
#sed -i '/passwd/ {s/taosdata/khroot/g}'  ${install_dir}/examples/c/*.c
#sed -i '/root/   {s/taosdata/hkroot/g}'  ${install_dir}/examples/c/*.c
#
#if [[ "$pagMode" != "lite" ]] && [[ "$cpuType" != "aarch32" ]]; then
#  cp -r ${examples_dir}/JDBC   ${install_dir}/examples
#  cp -r ${examples_dir}/matlab ${install_dir}/examples
#  mv ${install_dir}/examples/matlab/TDengineDemo.m ${install_dir}/examples/matlab/khDemo.m
#  sed -i '/password/ {s/taosdata/khroot/g}'  ${install_dir}/examples/matlab/khDemo.m
#  cp -r ${examples_dir}/python ${install_dir}/examples
#  sed -i '/password/ {s/taosdata/khroot/g}'  ${install_dir}/examples/python/read_example.py
#  cp -r ${examples_dir}/R      ${install_dir}/examples
#  sed -i '/password/ {s/taosdata/khroot/g}'  ${install_dir}/examples/R/command.txt
#  cp -r ${examples_dir}/go     ${install_dir}/examples
#  mv ${install_dir}/examples/go/taosdemo.go ${install_dir}/examples/go/khdemo.go
#  sed -i '/root/ {s/taosdata/khroot/g}'  ${install_dir}/examples/go/khdemo.go
#fi
...
#  mv ${install_dir}/connector/python/taos ${install_dir}/connector/python/kinghistorian
#  sed -i '/password/ {s/taosdata/khroot/g}'  ${install_dir}/connector/python/kinghistorian/cinterface.py

#  sed -i '/password/ {s/taosdata/khroot/g}'  ${install_dir}/connector/python/kinghistorian/subscription.py

#  sed -i '/self._password/ {s/taosdata/khroot/g}'  ${install_dir}/connector/python/kinghistorian/connection.py
#fi
